 ...
 * @author Juan
 */
public class pVenta extends javax.swing.JDialog {
     ...
     */
    public pVenta(java.awt.Frame parent, boolean modal, EntityManagerFactory factory) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(pVenta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
